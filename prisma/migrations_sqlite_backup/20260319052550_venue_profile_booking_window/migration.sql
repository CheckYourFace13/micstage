...
INSERT INTO "new_Venue" ("city", "country", "createdAt", "formattedAddress", "googlePlaceId", "id", "lat", "lng", "name", "ownerId", "region", "slug", "updatedAt") SELECT "city", "country", "createdAt", "formattedAddress", "googlePlaceId", "id", "lat", "lng", "name", "ownerId", "region", "slug", "updatedAt" FROM "Venue";
DROP TABLE "Venue";
