...
INSERT INTO "new_Venue" ("about", "bookingOpensDaysAhead", "city", "country", "createdAt", "formattedAddress", "googlePlaceId", "id", "imageUrls", "lat", "lng", "name", "ownerId", "performanceFormat", "providesBacklineShared", "providesBassAmp", "providesDiBox", "providesDrumKit", "providesGuitarAmp", "providesKeyboard", "providesLightingBasic", "providesMonitors", "providesPA", "providesSpeakersMics", "region", "seriesEndDate", "seriesStartDate", "slug", "updatedAt") SELECT "about", "bookingOpensDaysAhead", "city", "country", "createdAt", "formattedAddress", "googlePlaceId", "id", "imageUrls", "lat", "lng", "name", "ownerId", "performanceFormat", "providesBacklineShared", "providesBassAmp", "providesDiBox", "providesDrumKit", "providesGuitarAmp", "providesKeyboard", "providesLightingBasic", "providesMonitors", "providesPA", "providesSpeakersMics", "region", "seriesEndDate", "seriesStartDate", "slug", "updatedAt" FROM "Venue";
DROP TABLE "Venue";
