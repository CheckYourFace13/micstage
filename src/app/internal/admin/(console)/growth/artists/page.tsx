...
export default async function AdminGrowthArtistsPage(props: {
  ...
  const filters = { marketSlug: market, leadType: "ARTIST" as const, pipelineOnly };
  ...
  return (
    <main className="mx-auto max-w-7xl px-3 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h1 className="text-lg font-semibold text-white">Artists to contact</h1>
