...
import { MESSAGES_REPLY_SUBMIT_PATH } from "../actions";

export function MessageReplyForm({ threadId }: { threadId: string }) {
  return (
    <form method="post" action={MESSAGES_REPLY_SUBMIT_PATH} className="mt-6 grid gap-3 border-t border-white/10 pt-6">
