  ...
  return (
    <div className="min-h-dvh bg-black text-white">
      <main className="mx-auto w-full max-w-xl px-6 py-16">
        ...
        <p className="mt-2 text-sm text-white/70">Promoters can request a secure reset link by email.</p>

        <form action={requestPromoterPasswordReset} className="mt-8 grid gap-4 rounded-2xl border border-white/10 bg-white/5 p-6">
          {showRate ? (
