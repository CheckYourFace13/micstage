...
/**
 * Paginates Eventbrite public search near Chicago. Requires personal OAuth token with event read scope.
 */
    ...
    async discover(ctx: GrowthLeadDiscoveryContext) {
      ...
      for (const ev of events) {
        ...
        out.push({
          ...
          internalNotes: "Eventbrite search (Chicago radius). Verify venue before outreach.",
        });
      }
      return out;
    },
