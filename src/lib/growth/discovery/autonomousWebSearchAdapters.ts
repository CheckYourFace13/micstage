...
const OPEN_MIC_QUERY_CORES = [
  ...
  '"open mic night" brewery OR taproom OR pub',
  '"acoustic open mic" venue',
  "acoustic open mic night venue",
  '"comedy open mic" club OR venue',
  "comedy open mic night club",
  '"stand-up open mic" OR "standup open mic" club',
  '"poetry open mic" venue OR cafe',
  '"spoken word open mic" cafe OR venue',
  '"open jam" OR "open stage" music venue bar',
  '"jam night" "open" live music venue bar',
  ...
  '"open stage" music venue OR cafe',
  ...
  '"open mic" coffee shop OR cafe OR coffeehouse',
  '"open mic" restaurant OR bar OR pub',
  '"open mic" comedy club OR theater OR "arts center"',
  '"open mic" "music venue"',
