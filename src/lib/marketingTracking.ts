...
export type MarketingEventName =
  ...
  | "registration_page_view_venue"
  | "registration_page_view_host"
  | "registration_page_view_performer"
  | "registration_form_started_venue"
  | "registration_form_started_host"
  | "registration_form_started_performer"
  | "registration_submitted_venue"
  | "registration_submitted_host"
  | "registration_submitted_performer"
  | "registration_completed_venue"
  | "registration_completed_host"
  | "registration_completed_performer"
  | "claim_started"
  | "claim_submitted"
  | "claim_email_opened"
  | "claim_page_reached"
