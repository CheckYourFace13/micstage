...
export const MICSTAGE_VENUE_FREE_SERVICES = [
  ...
  "Optional online signup so performers claim spots without double-signup",
  "Shareable lineup board and QR code for walk-up signup",
  "Optional on-site signup rules (hours-before or geofence)",
  "Public discovery on MicStage (map, find-open-mics, metro pages) once you claim and publish your schedule",
  "Proactive marketing help from MicStage once your room is live — not before",
...
export function buildListingClaimApprovedPayload(input: {
  ...
  const textBody = [
    ...
    "2. Enable performer signups when you are ready",
  ...
  const htmlBody = [
    ...
    "<ol><li>Confirm your open mic schedule</li><li>Enable performer signups when you are ready</li><li>Share your lineup link or QR code</li></ol>",
